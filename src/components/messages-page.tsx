...
export function MessagesPage() {
    ...
    return (
        <Card className="h-[calc(100vh-10rem)] w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 shadow-lg overflow-hidden">
            {/* User List Panel */}
            <div className={cn("border-r flex-col", selectedUser ? "hidden md:flex" : "flex")}>
                    ...
                    <nav className="p-2 space-y-1">
                        {allOtherUsers.map(user => (
                            <Button
                                ...
                                className={cn("w-full justify-start h-auto py-2 px-3", selectedUser?.uid === user.uid && "bg-accent")}
                            >
            ...
            {/* Chat Panel */}
            <div className={cn("md:col-span-2 lg:col-span-3 flex-col", selectedUser ? "flex" : "hidden md:flex")}>
                {selectedUser ? (
                    <>
